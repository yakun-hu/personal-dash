...
<html><body><h1>Dash-edit.php</h1>
<?php echo 'Page name: ' . select_single_grid($_GET['author'], $_GET['post_ID'], 'post_title'); ?> | <a href="process-redir/log.out-redir">Log-out</a><br><br>
...
<?php for ($x = 1; $x <= 9; $x++) {
  ...
  <td><input type="text" id="url<?php echo $x;?>" name="url<?php echo $x;?>" value="<?php echo select_single_grid($_GET['author'], $_GET['post_ID'], $url_column);?>" minlength="1" maxlength="200"></td></tr>
<?php }?></table><input type="submit" name="submit" value="Save">
</form></body></html>
